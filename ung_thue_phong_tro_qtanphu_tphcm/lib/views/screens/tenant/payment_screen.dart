...
class _PaymentScreenState extends ConsumerState<PaymentScreen> {
  ...
  Future<void> _onPaymentConfirm(String landlordName, String tenantName, String tenantId) async {
    setState(() {
      _isProcessing = true;
    });
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Xác nhận đặt cọc và thanh toán thành công! 🎉'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: landlordAsync.when(
        ...
        data: (landlord) {
          if (landlord == null) {
            return const Center(child: Text('Không tìm thấy thông tin chủ nhà'));
          }
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          const Text('Số tiền cọc giữ chỗ:', style: AppTypography.bodyMD),
                          Text(
                        ...
                        SizedBox(
                          ...
                          child: CachedNetworkImage(
                            ...
                            errorWidget: (_, __, ___) => const Center(
                              child: Icon(Icons.qr_code, size: 100, color: AppColors.outline),
                            ),
                          ),
                        ),
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Hoặc chuyển khoản thủ công:', style: AppTypography.labelSM),
                      const SizedBox(height: AppSpacing.sm),
                      _buildCopyableRow('Ngân hàng', 'MB Bank (Quân Đội)', copyable: false),
                      _buildCopyableRow('Số tài khoản', stk, onCopy: () => _copyToClipboard(stk, 'Số tài khoản')),
                      _buildCopyableRow('Chủ tài khoản', nameNoSign, copyable: false),
                      _buildCopyableRow(
                        'Số tiền',
                        '${_formatCurrency(widget.amount)}đ',
                ...
                AppButton(
                  ...
                  onPressed: _isProcessing 
                      ? null 
                      : () => _onPaymentConfirm(landlord.fullName, tenantName, tenantId),
  ...
  Widget _buildCopyableRow(String label, String value, {bool copyable = true, VoidCallback? onCopy}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 100,
            child: Text(label, style: AppTypography.bodySM.copyWith(color: AppColors.onSurfaceVariant)),
          ),
          Expanded(
            child: Text(
              value,
